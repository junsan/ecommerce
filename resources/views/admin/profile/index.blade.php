...
<section class="section">
    ...
    <div class="row mt-sm-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">  
                    ...
                    <div>
                        <image width="100" src="{{asset(Auth::user()->image)}}" />
                    </div>
                    <label>Image</label>
        ...
        <div class="col-12 col-md-12 col-lg-7">
        <div class="card">
            <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate="" action="{{route('admin.profile.update.password')}}">
            @csrf
            <div class="card-header">
