...
<section class="product_popup_modal">
    ...
    ==============================-->
        @include('frontend.home.section.top-categories')
    <!--============================
    ...
    ==============================-->
        @include('frontend.home.section.categories-one')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    <!--============================
        ELECTRONIC PART START  
    ==============================-->
        @include('frontend.home.section.categories-two')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    <!--============================
        HOME BLOGS START
    ==============================-->
        @include('frontend.home.section.blogs')
    <!--============================
        HOME BLOGS END
    ==============================-->
